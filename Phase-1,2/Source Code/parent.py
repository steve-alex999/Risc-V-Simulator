...
for i in range(len(mc_code)):
    ...
    EXEC_data.execute_data(value,type,address)
...
for i in range(i+2,len(mc_code)):
    ...
    memory.write_code_line_to_mem(int(address,16), binary_equivalent)
...
# print(hex(memory.data_stop))
# print(memory.read_byte_from_mem(int("0x0",16)))
